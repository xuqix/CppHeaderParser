...
print("\n#defines areaaaaaaaaaaaaaaaaaa:")
for define in cppHeader.defines:
    print(" %s"%define)

sampleClass = cppHeader.classes["OmegaClass"]
#sampleClass = cppHeader.classes["AlphaClass"]
meth3 = [m for m in sampleClass["methods"]["public"] ] #get meth3
tt = [t for t in meth3] #get meth3s parameters
for l in tt:
    print l['path']
